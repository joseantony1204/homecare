...
<table width="100%" border="0">	
	...
	<tr>
		...
		<td align="rigth" width="25%"><strong>FECHA CORTE:</strong> '.$Informes->INFO_FECHA.'</td>
    </tr>
		...
		<td colspan="4">
			...
			<table width="100%" border="0.5">
				...
				<tr>
					...
					<td align="center" width="17%"><strong>FECHA VENCE PAGO</strong></td>
				</tr>
				';
				$i=1;
