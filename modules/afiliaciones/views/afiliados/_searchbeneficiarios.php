...
<div id="search-beneficiarios" class="beneficiarios-search">

    <?php $form = ActiveForm::begin([
		'id' => 'form-search-beneficiarios', 
    ...
    <div class="form-group">
        <?php echo Html::button('<i class="fa fa-search"> Buscar</i>', [ 'class' => 'btn btn-success', 'id' => 'btn-search-beneficiarios', 'title' => 'Buscar' ]); ?>						
		<?php echo Html::button('<i class="fa fa-ban"> Cancelar</i>', [ 'class' => 'btn btn-danger', 'onClick' => '$("#div-search-beneficiarios").hide(); $("#div-index-beneficiarios").show();', 'title' => 'Cancelar' ]); ?>
    </div>
...
<?php
$this->registerJs(' 
 $("#btn-search-beneficiarios").on("click", function(){ 
   var url = "'.Yii::$app->urlManager->createUrl(['/afiliaciones/beneficiarios/search']).'";
   var form = $("#form-search-beneficiarios");
   var form_afiliados = $("#form-create-beneficiarios");
	 ...
	 url: url,
		...
		success:function(data){
			if(data != "")
		    {
				...
				if(parsed!=null){
					if(parsed.info == "true"){
					alert("BENEFICIARIO EXISTENTE:\n--------------------------\n\nEl número de identificación ingresado pertenece a una persona que ya esta registrada como beneficiario en la base de datos.");							
