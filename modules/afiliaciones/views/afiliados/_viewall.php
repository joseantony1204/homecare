...
<?php echo Html::button('<i class="fa fa-ban"> Cancelar</i>', [ 'class' => 'btn btn-danger', 'onClick' => '$("#div-view-personas").hide(); $("#div-index-personas").show()', 'title' => 'Cancelar' ]); ?>
						
					

<script type="application/javascript">
function viewalldata(id){
	var url = "<?=Yii::$app->urlManager->createUrl(["/afiliaciones/afiliados/getalldataview?id="])?>"+id;
	$.ajax(
	{
	    url: url,
		type:'POST',
