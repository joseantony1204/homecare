...
<table width="100%" border="1">	
	<tr>
		<td>
			<table width="100%" border="0">	
				<tr>
					<td align="center" border="0" bgcolor= "#59BF2E"><font color="#FFFFFF"><h4>POROTOCOLO GENERAL DE SOLICITUD DE LOS SERVICIOS DE MEDIGROUP HOME CARE S.A.S</h4></font></td>
				</tr>
...
Yii::$app->mailer->compose()
	...
	->setTo([$Afiliados->persona->PERS_EMAIL => $Afiliados->persona->PERS_PRIMERAPELLIDO.' '.$Afiliados->persona->PERS_PRIMERNOMBRE])
	->setSubject("Soporte de vinculación")
	->setHtmlBody(
	"
		<div align='center'> <h2>Bienvenidos a MediGroup Home Care</h2></div>
		<p align='justify'>Para nosotros en muy importante el bienestar y la excelencia en la atención de nuestros usuarios, a continuación le hacemos una relación de todos los servicios que ha adquirido al pertenecer a nuestro grupo empresarial MEDIGROUP.</p>
		<ul style='list-style-type:square'>
			<li align='justify'>ATENCION MEDICA EN CASA</li>
			<li align='justify'>ORIENTACION MEDICA TELEFONICA</li>
			<li align='justify'>TOMA DE MUESTRAS EN CASA Y ENVIO DE RESULTADOS A SU CORREO ELECTRONICO</li>
			<li align='justify'>CITAS CON ESPECIALISTAS (PEDIATRIA, GINECOLOGIA Y MEDICINA INTERNA) DE FORMA DIRECTA CON PROGRAMACION INMEDIATA.</li>
			<li align='justify'>LABORATORIO CLINICO.</li>
		</ul>
		<p align='justify'>Podrá acceder a estos servicios comunicándose con nosotros a la línea <strong>7270680</strong>, marcando la <strong>OPCIÓN 5</strong>.</p>	
		<div align='center'> 
