				...
				<table width="100%" border="0" align="center" class="table">
					<tr>
							<td width="100%" align="left" colspan="4">
								<div class="brand-text brand-big hidden-lg-down">
									<strong>
										<h3>
											<i class="fa fa-cogs"></i> Administrar cuentas de: 
											( 
					...
					<tr>
						<td width="5%" align="center">						
							...
							<?php echo Html::button('<i class="fa fa-plus"> Nueva Cuenta</i>', [ 'class' => 'btn btn-success', 'id' => 'btn-create-cuentasbancarias', 'title' => 'Agregar cuentasbancarias' ]); ?>   			 
						</td>
						
						<td width="5%" align="center">
						   <?php echo Html::button('<i class="fa fa-repeat"> Actualizar pestaña</i>', [ 'class' => 'btn btn-info', 'id' => 'btn-refresh-grid-cuentasbancarias', 'title' => 'Actualizar grid' ]); ?>							  			 
						</td>
						<td width="5%" align="center">							
		...
		<tr>
            <td>
			    <div id="div-create-cuentasbancarias" class="div-create-cuentasbancarias" style="display:none" >
					<?php echo $this->render('_createcuentas',['model'=>$Cuentasbancarias]); ?>
							...
							'buttons' => [
							   ...
							   'view' =>function ($url, $model) {
								...
								'delete' =>function ($url, $model) {
									$url = Url::to(['/afiliaciones/cuentasbancarias/delete', 'id' => $model->FOPA_ID]);
