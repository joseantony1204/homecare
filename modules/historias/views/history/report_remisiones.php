...
$tittle = 'REMISION_DE_SERVICIOS_No.'.$History->AGEN_ID;
...
<table width="100%" border="0">	  
	...
	<tr>
		<td align="left" border="0"><h3>ORDEN DE REMISION DE SERVICIOS | Fecha: '.$fechtencion.'</h3></td>
	</tr>
...
if($sw==true){
	...
	Yii::$app->mailer->compose()
		...
		->setSubject("Soporte de remisiones")
		->setHtmlBody(
		"
