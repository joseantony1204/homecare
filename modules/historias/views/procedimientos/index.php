...
<div class="procedimientos-index">
	...
	<table width="100%" border="0" align="center">
            ...
            <td>			
				<table width="100%" border="0" align="center" class="table">
					...
					<tr>
						...
						<td width="5%" align="center">
						   <?php echo Html::button('<i class="fa fa-repeat"></i>', [ 'class' => 'btn btn-info', 'id' => 'btn-refresh-grid-procedimientos', 'title' => 'Actualizar grid' ]); ?>							  			 
						</td>
						<td width="5%" align="center">							
		...
		<tr>
            <td>
				<div id="div-update-procedimientos" class="div-update-procedimientos" style="display:none" >
					<?php echo $this->render('_update',['model'=>$Procedimientos]); ?>
				</div><!-- update-form -->
			</td>
        </tr>
		...
		<tr>
            <td>
			    <div id="div-create-procedimientos" class="div-create-procedimientos" style="display:none" >
					<?php echo $this->render('_create',['model'=>$Procedimientos]); ?>
